require("todo-comments").setup({
	...
	keywords = {
		...
		TODO = { icon = " ", color = "info", alt = { "todo", "unimplemented" } }, -- lowercase alts catch Rust macros todo!() / unimplemented!()
	...
	highlight = {
		...
		-- second pattern matches Rust macro form: todo!(...) / unimplemented!(...)
	...
	search = {
		...
		-- `KEYWORD:` (comments) or `KEYWORD!(` (Rust macros: todo!/unimplemented!)
